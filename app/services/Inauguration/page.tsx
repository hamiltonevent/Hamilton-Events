...
import { ArrowLeft, TrendingUp, Camera, Zap, Users, CheckCircle } from "lucide-react"
import { useLanguage } from "@/components/language-context"
import { useTranslation } from "@/lib/translations"
import { inaugurationTranslations } from "@/lib/translations/Inauguration"
import AdSenseAd, { AdConfigs } from "@/components/adsense-ad"

export default function InaugurationPage() {
  const { language } = useLanguage()
  const t = useTranslation(language)
  const tc = (key: string) => (inaugurationTranslations[language]as any)?.[key] || key
