...
import { corporateConferencesTranslations } from "@/lib/translations/corporate-conferences"
import AdSenseAd, { AdConfigs } from "@/components/adsense-ad"

export default function CorporateConferencesPage() {
  const { language } = useLanguage()
  const t  = useTranslation(language)
  const tc = (key: string) => (corporateConferencesTranslations[language] as any)?.[key] || key
