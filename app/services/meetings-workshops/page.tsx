...
import { ArrowLeft, Settings, Users, Lightbulb, CheckCircle } from "lucide-react"
import { useLanguage } from "@/components/language-context"
import { useTranslation } from "@/lib/translations"
import { meetingsWorkshopsTranslations } from "@/lib/translations/meetings-workshops"
import AdSenseAd, { AdConfigs } from "@/components/adsense-ad"

export default function MeetingsWorkshopsPage() {
  const { language } = useLanguage()
  const t = useTranslation(language)
  const tc = (key: string) => (meetingsWorkshopsTranslations[language] as any)?.[key] || key
